...
use xpocketmc\event\entity\EntityDespawnEvent;
use xpocketmc\event\entity\EntityMotionEvent;
use xpocketmc\event\entity\EntityRegainHealthEvent;
use xpocketmc\event\entity\EntitySpawnEvent;
use xpocketmc\event\entity\EntityTeleportEvent;
	...
	protected function broadcastMovement(bool $teleport = false) : void{
		NetworkBroadcastUtils::broadcastPackets($this->hasSpawned, [MoveActorAbsolutePacket::create(
			...
			(
				...
				//See https://github.com/pmmp/xpocketmc-MP/issues/4394

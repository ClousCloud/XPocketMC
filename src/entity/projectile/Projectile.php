...
use xpocketmc\event\entity\EntityCombustByEntityEvent;
...
use xpocketmc\event\entity\ProjectileHitBlockEvent;
use xpocketmc\event\entity\ProjectileHitEntityEvent;

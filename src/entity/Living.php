...
use xpocketmc\entity\animation\DeathAnimation;
use xpocketmc\entity\animation\HurtAnimation;
use xpocketmc\entity\animation\RespawnAnimation;
use xpocketmc\entity\effect\EffectInstance;
use xpocketmc\entity\effect\EffectManager;
...
use xpocketmc\world\sound\BurpSound;
use xpocketmc\world\sound\EntityLandSound;
use xpocketmc\world\sound\EntityLongFallSound;
use xpocketmc\world\sound\EntityShortFallSound;
...
abstract class Living extends Entity{
	...
	protected function initEntity(CompoundTag $nbt) : void{
		...
		if(($healFTag = $nbt->getTag(self::TAG_LEGACY_HEALTH)) instanceof FloatTag){
			...
			$health = $healthTag->getValue(); //Older versions of xpocketmc-MP incorrectly saved this as a short instead of a float

...
use xpocketmc\entity\utils\ExperienceUtils;
use xpocketmc\event\player\PlayerExperienceChangeEvent;
use xpocketmc\item\Durable;
use xpocketmc\item\enchantment\VanillaEnchantments;
use xpocketmc\utils\Limits;
use xpocketmc\world\sound\XpCollectSound;
use xpocketmc\world\sound\XpLevelUpSound;

...
final class SurvivalBlockBreakHandler{
	...
	private function calculateBreakProgressPerTick() : float{
		...
		//TODO: improve this to take stuff like swimming, ladders, enchanted tools into account, fix wrong tool break time calculations for bad tools (pmmp/xpocketmc-MP#211)

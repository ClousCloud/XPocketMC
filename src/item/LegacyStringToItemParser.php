 ...
 *
 * WARNING: This class does NOT support items added during or after xpocketmc-MP 5.0.0. Use StringToItemParser for
 * modern items.
 */
final class LegacyStringToItemParser{
	...
	private static function make() : self{
		...
		$mappingsRaw = Filesystem::fileGetContents(Path::join(\xpocketmc\RESOURCE_PATH, 'item_from_string_bc_map.json'));

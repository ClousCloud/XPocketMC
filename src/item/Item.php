...
use xpocketmc\block\BlockBreakInfo;
use xpocketmc\block\BlockToolType;
use xpocketmc\block\VanillaBlocks;
use xpocketmc\data\bedrock\EnchantmentIdMap;
use xpocketmc\data\bedrock\item\ItemTypeDeserializeException;
...
class Item implements \JsonSerializable{
	...
	/**
	 * Deserializes item JSON data produced by json_encode()ing Item instances in older versions of xpocketmc-MP.

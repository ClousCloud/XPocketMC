...
class PluginsCommand extends VanillaCommand{
	...
	public function __construct(){
		parent::__construct(
			"plugins",
			KnownTranslationFactory::xpocketmc_command_plugins_description(),
			null,
			["pl"]
		);
	...
	public function execute(CommandSender $sender, string $commandLabel, array $args){
		...
		$sender->sendMessage(KnownTranslationFactory::xpocketmc_command_plugins_success((string) count($list), implode(TextFormat::RESET . ", ", $list)));
		return true;
	}
}
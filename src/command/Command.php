...
use xpocketmc\command\utils\CommandException;
...
abstract class Command{
	...
	public function testPermission(CommandSender $target, ?string $permission = null) : bool{
		...
		if($this->permissionMessage === null){
			$target->sendMessage(KnownTranslationFactory::xpocketmc_command_error_permission($this->name)->prefix(TextFormat::RED));

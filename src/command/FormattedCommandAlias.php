...
class FormattedCommandAlias extends Command{
	...
	public function __construct(
		...
		parent::__construct($alias, KnownTranslationFactory::xpocketmc_command_userDefined_description());
	}
	...
	public function execute(CommandSender $sender, string $commandLabel, array $args){
		...
		foreach($commands as $commandArgs){
			...
			if(($target = $commandMap->getCommand($commandLabel)) !== null){
				...
				$sender->sendMessage($sender->getLanguage()->translate(KnownTranslationFactory::xpocketmc_command_notFound($commandLabel, "/help")->prefix(TextFormat::RED)));

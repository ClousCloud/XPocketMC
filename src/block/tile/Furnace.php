...
use xpocketmc\block\Furnace as BlockFurnace;
use xpocketmc\block\inventory\FurnaceInventory;
use xpocketmc\crafting\FurnaceRecipe;
use xpocketmc\crafting\FurnaceType;
use xpocketmc\event\inventory\FurnaceBurnEvent;
use xpocketmc\event\inventory\FurnaceSmeltEvent;

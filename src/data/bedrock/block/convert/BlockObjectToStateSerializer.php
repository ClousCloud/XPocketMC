...
namespace xpocketmc\data\bedrock\block\convert;

use xpocketmc\block\ActivatorRail;
use xpocketmc\block\AmethystCluster;
use xpocketmc\block\Anvil;
use xpocketmc\block\Bamboo;
use xpocketmc\block\BambooSapling;
use xpocketmc\block\Barrel;
use xpocketmc\block\Bed;
use xpocketmc\block\Beetroot;
use xpocketmc\block\Bell;
use xpocketmc\block\BigDripleafHead;
use xpocketmc\block\BigDripleafStem;
use xpocketmc\block\Block;
use xpocketmc\block\BoneBlock;
use xpocketmc\block\BrewingStand;
use xpocketmc\block\BrownMushroomBlock;
use xpocketmc\block\Button;
use xpocketmc\block\Cactus;
use xpocketmc\block\Cake;
use xpocketmc\block\CakeWithCandle;
use xpocketmc\block\CakeWithDyedCandle;
use xpocketmc\block\Candle;
use xpocketmc\block\Carpet;
use xpocketmc\block\Carrot;
use xpocketmc\block\CarvedPumpkin;
use xpocketmc\block\CaveVines;
use xpocketmc\block\Chain;
use xpocketmc\block\ChemistryTable;
use xpocketmc\block\Chest;
use xpocketmc\block\ChiseledBookshelf;
use xpocketmc\block\ChorusFlower;
use xpocketmc\block\CocoaBlock;
use xpocketmc\block\Concrete;
use xpocketmc\block\ConcretePowder;
use xpocketmc\block\Copper;
use xpocketmc\block\CopperSlab;
use xpocketmc\block\CopperStairs;
use xpocketmc\block\Coral;
use xpocketmc\block\CoralBlock;
use xpocketmc\block\DaylightSensor;
use xpocketmc\block\DetectorRail;
use xpocketmc\block\Dirt;
use xpocketmc\block\Door;
use xpocketmc\block\DoublePitcherCrop;
use xpocketmc\block\DoublePlant;
use xpocketmc\block\DoubleTallGrass;
use xpocketmc\block\DyedCandle;
use xpocketmc\block\DyedShulkerBox;
use xpocketmc\block\EnderChest;
use xpocketmc\block\EndPortalFrame;
use xpocketmc\block\EndRod;
use xpocketmc\block\Farmland;
use xpocketmc\block\FenceGate;
use xpocketmc\block\FillableCauldron;
use xpocketmc\block\Fire;
use xpocketmc\block\FloorBanner;
use xpocketmc\block\FloorCoralFan;
use xpocketmc\block\FloorSign;
use xpocketmc\block\Froglight;
use xpocketmc\block\FrostedIce;
use xpocketmc\block\Furnace;
use xpocketmc\block\GlazedTerracotta;
use xpocketmc\block\GlowLichen;
use xpocketmc\block\HayBale;
use xpocketmc\block\Hopper;
use xpocketmc\block\ItemFrame;
use xpocketmc\block\Ladder;
use xpocketmc\block\Lantern;
use xpocketmc\block\Lava;
use xpocketmc\block\Leaves;
use xpocketmc\block\Lectern;
use xpocketmc\block\Lever;
use xpocketmc\block\Light;
use xpocketmc\block\LightningRod;
use xpocketmc\block\LitPumpkin;
use xpocketmc\block\Loom;
use xpocketmc\block\MelonStem;
use xpocketmc\block\MobHead;
use xpocketmc\block\NetherPortal;
use xpocketmc\block\NetherVines;
use xpocketmc\block\NetherWartPlant;
use xpocketmc\block\PinkPetals;
use xpocketmc\block\PitcherCrop;
use xpocketmc\block\Potato;
use xpocketmc\block\PoweredRail;
use xpocketmc\block\PumpkinStem;
use xpocketmc\block\Rail;
use xpocketmc\block\RedMushroomBlock;
use xpocketmc\block\RedstoneComparator;
use xpocketmc\block\RedstoneLamp;
use xpocketmc\block\RedstoneOre;
use xpocketmc\block\RedstoneRepeater;
use xpocketmc\block\RedstoneTorch;
use xpocketmc\block\RedstoneWire;
use xpocketmc\block\RuntimeBlockStateRegistry;
use xpocketmc\block\Sapling;
use xpocketmc\block\SeaPickle;
use xpocketmc\block\SimplePillar;
use xpocketmc\block\SimplePressurePlate;
use xpocketmc\block\Slab;
use xpocketmc\block\SmallDripleaf;
use xpocketmc\block\SnowLayer;
use xpocketmc\block\Sponge;
use xpocketmc\block\StainedGlass;
use xpocketmc\block\StainedGlassPane;
use xpocketmc\block\StainedHardenedClay;
use xpocketmc\block\StainedHardenedGlass;
use xpocketmc\block\StainedHardenedGlassPane;
use xpocketmc\block\Stair;
use xpocketmc\block\StoneButton;
use xpocketmc\block\Stonecutter;
use xpocketmc\block\StonePressurePlate;
use xpocketmc\block\Sugarcane;
use xpocketmc\block\SweetBerryBush;
use xpocketmc\block\TNT;
use xpocketmc\block\Torch;
use xpocketmc\block\TorchflowerCrop;
use xpocketmc\block\Trapdoor;
use xpocketmc\block\TrappedChest;
use xpocketmc\block\Tripwire;
use xpocketmc\block\TripwireHook;
use xpocketmc\block\UnderwaterTorch;
use xpocketmc\block\utils\BrewingStandSlot;
use xpocketmc\block\utils\CoralType;
use xpocketmc\block\utils\DirtType;
use xpocketmc\block\utils\DripleafState;
use xpocketmc\block\utils\DyeColor;
use xpocketmc\block\utils\FroglightType;
use xpocketmc\block\utils\LeverFacing;
use xpocketmc\block\VanillaBlocks as Blocks;
use xpocketmc\block\Vine;
use xpocketmc\block\Wall;
use xpocketmc\block\WallBanner;
use xpocketmc\block\WallCoralFan;
use xpocketmc\block\WallSign;
use xpocketmc\block\Water;
use xpocketmc\block\WeightedPressurePlateHeavy;
use xpocketmc\block\WeightedPressurePlateLight;
use xpocketmc\block\Wheat;
use xpocketmc\block\Wood;
use xpocketmc\block\WoodenButton;
use xpocketmc\block\WoodenDoor;
use xpocketmc\block\WoodenPressurePlate;
use xpocketmc\block\WoodenStairs;
use xpocketmc\block\WoodenTrapdoor;
use xpocketmc\block\Wool;
...
use xpocketmc\data\bedrock\block\BlockStateSerializer;

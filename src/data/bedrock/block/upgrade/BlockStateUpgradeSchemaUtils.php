...
use xpocketmc\data\bedrock\block\upgrade\model\BlockStateUpgradeSchemaModel;
use xpocketmc\data\bedrock\block\upgrade\model\BlockStateUpgradeSchemaModelBlockRemap;

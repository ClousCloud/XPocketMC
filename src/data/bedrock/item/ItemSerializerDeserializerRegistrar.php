...
use xpocketmc\data\bedrock\CompoundTypeIds;
use xpocketmc\data\bedrock\DyeColorIdMap;
use xpocketmc\data\bedrock\item\ItemTypeNames as Ids;
use xpocketmc\data\bedrock\item\SavedItemData as Data;
use xpocketmc\data\bedrock\MedicineTypeIdMap;
use xpocketmc\data\bedrock\MobHeadTypeIdMap;
use xpocketmc\data\bedrock\PotionTypeIdMap;
use xpocketmc\data\bedrock\SuspiciousStewTypeIdMap;
use xpocketmc\item\Banner;
use xpocketmc\item\Dye;
use xpocketmc\item\Item;
use xpocketmc\item\Medicine;
use xpocketmc\item\Potion;
use xpocketmc\item\SplashPotion;
use xpocketmc\item\SuspiciousStew;
use xpocketmc\item\VanillaItems as Items;
...
final class ItemSerializerDeserializerRegistrar{
	...
	/**
	 * Registers mappings for item IDs which directly correspond to xpocketmc-MP blockitems.
	...
	/**
	 * Registers mappings for item IDs which directly correspond to xpocketmc-MP items.
	 */
	...
	/**
	 * Registers mappings for item IDs which map to different xpocketmc-MP item types, depending on their meta
	 * values.
	 ...
	 *
	 * Most of these are single xpocketmc-MP items which map to multiple IDs depending on their properties, which is

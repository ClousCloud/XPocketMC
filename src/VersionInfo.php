...
final class VersionInfo{
	public const NAME = "xpocketmc";
	public const BASE_VERSION = "1.0.0";
	public const IS_DEVELOPMENT_BUILD = true;
	public const BUILD_CHANNEL = "stable";

	/**
	 * xpocketmc-MP-specific version ID for world data. Used to determine what fixes need to be applied to old world
	 ...
	 */
	public const TAG_WORLD_DATA_VERSION = "XPMCDataVersion"; //TAG_Long
	...
	public static function GIT_HASH() : string{
		if(self::$gitHash === null){
			...
			if(\Phar::running(true) === ""){
				$gitHash = Git::getRepositoryStatePretty(\xpocketmc\PATH);
			}else{

...
class SetupWizard{
	...
	private function showLicense() : bool{
		$this->message($this->lang->translate(KnownTranslationFactory::welcome_to_xpocketmc(VersionInfo::NAME)));
		echo <<<LICENSE
...
LICENSE;
	...
	private function endWizard() : void{
		...
		$this->message($this->lang->translate(KnownTranslationFactory::xpocketmc_plugins()));
		$this->message($this->lang->translate(KnownTranslationFactory::xpocketmc_will_start(VersionInfo::NAME)));

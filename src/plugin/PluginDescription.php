...
use xpocketmc\permission\Permission;
use xpocketmc\permission\PermissionParser;
use xpocketmc\permission\PermissionParserException;
...
class PluginDescription{
	...
	private function loadMap(array $plugin) : void{
		...
		if(stripos($this->main, "xpocketmc\\") === 0){
			throw new PluginDescriptionParseException("Invalid Plugin main, cannot start within the xpocketmc namespace");
		}

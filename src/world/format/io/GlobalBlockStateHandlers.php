...
use xpocketmc\data\bedrock\block\convert\BlockObjectToStateSerializer;
use xpocketmc\data\bedrock\block\convert\BlockStateToObjectDeserializer;
use xpocketmc\data\bedrock\block\upgrade\BlockDataUpgrader;
use xpocketmc\data\bedrock\block\upgrade\BlockIdMetaUpgrader;
use xpocketmc\data\bedrock\block\upgrade\BlockStateUpgrader;
use xpocketmc\data\bedrock\block\upgrade\BlockStateUpgradeSchemaUtils;
use xpocketmc\data\bedrock\block\upgrade\LegacyBlockIdToStringIdMap;
use xpocketmc\utils\Filesystem;
use Symfony\Component\Filesystem\Path;
use const PHP_INT_MAX;
use const xpocketmc\BEDROCK_BLOCK_UPGRADE_SCHEMA_PATH;
